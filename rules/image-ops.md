...
## 1.5 유형 라우팅 — 도식·인포그래픽·텍스트 이미지 = 생성(GPT-image-2) 1차 후보 (사용자 2026-08-23 지시 — 「GD 의 GPT-image-2 에 대한 오해가 계속 있다」 정정)
